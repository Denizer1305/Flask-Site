...
owner = {"surname": "Ivanov",
         "name": "Ivan",
         "phone_number": "+0(000)000-00-00",
         "email": "contanct@mail.ru",
         "anim_item": ['Ivanov Ivan',
                       'Developer',
                       'UI Specialist', ],
...
educations = [{"year": "2017", "item": "Mobile Web", "where": "Master Design",
               "comment": "Please tell your friends about Tooplate website. That would be very helpful. We need your "
                          "support."},
              {"year": "2015", "item": "User Interfaces", "where": "Creative Agency", "site": "https://www.faceboo"".com/tooplate",
               "namesite": "Tooplate",
